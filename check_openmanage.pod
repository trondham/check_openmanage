...
This option will cause the plugin to use IPv6 instead of IPv4, which
is the default.

=item --tcp

This option will cause the plugin to change the transport protocol
from UDP (default) to TCP.
